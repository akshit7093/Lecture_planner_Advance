...
const Sidebar = ({ collapsed, toggleSidebar, onPathwaySelect, selectedPathwayId }: SidebarProps) => {
  ...
  const { register, handleSubmit, setValue, formState: { errors }, watch } = useForm<PathwayForm>({
  ...
  return (
    <div className={`h-full bg-white flex flex-col overflow-hidden transition-all duration-300 ${sidebarClasses}`}>
      ...
      <div className="p-4 border-b border-gray-200">
        <h2 className="text-sm uppercase font-semibold text-gray-600 mb-3">Start New Pathway</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <Label htmlFor="topic" className="block text-sm font-medium mb-1">Topic/Syllabus</Label>
            <Input
              id="topic"
          ...
          <div>
            <Label htmlFor="timespan" className="block text-sm font-medium mb-1">Time Span</Label>
            <Select 
          ...
          {showCustom && (
            <div>
              <Label htmlFor="customDays" className="block text-sm font-medium mb-1">Number of Days</Label>
              <Input
                id="customDays"
                type="number"
                min={1}
          ...
          <div>
            <Label htmlFor="complexity" className="block text-sm font-medium mb-1">Complexity Level</Label>
            <Select 
              onValueChange={(value) => setValue("complexity", value as "beginner" | "intermediate" | "advanced")}
      ...
      <div className="p-4 border-b border-gray-200 flex-grow overflow-auto">
        <h2 className="text-sm uppercase font-semibold text-gray-600 mb-3">Saved Pathways</h2>
          ...
          {isLoading ? (
            ...
            pathways.map((pathway: SavedPathway) => (
              ...
              >
                ...
                <span className="text-xs text-gray-500">{pathway.timespan}</span>
              </button>
            ))
          ) : (
      ...
      <div className="p-4 mt-auto border-t border-gray-200">
        <h2 className="text-sm uppercase font-semibold text-gray-600 mb-3">API Configuration</h2>
        <div className="space-y-2">
          <div>
            <Label htmlFor="api-model" className="block text-sm font-medium mb-1">AI Model</Label>
          ...
          <div className="opacity-50">
            ...
            <div className="bg-gray-100 p-2 rounded border border-gray-200 flex items-center">
              ...
              <Button variant="link" className="text-xs text-primary" disabled>Change</Button>
            </div>
          </div>
        </div>
      </div>
